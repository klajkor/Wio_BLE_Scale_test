...
const char MSG_TIMER_CREATE_ERROR[] = "Timer create error!";
const char MSG_TIMER_CREATED[] = "Timer created";
const char MSG_SENDING_COMMAND_TO_SCALE[] = "Sending command to scale: ";
const char MSG_COMMAND_LED_OFF[] = "LED Off";
const char MSG_COMMAND_LED_ON[] = "LED ON";
